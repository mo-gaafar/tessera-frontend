                          ...
                          >
                            <form className="form">
                              ...
                              {inputerror && (
                                ...
                                <div data-testid='titleerrormessage' className="error">{inputerror}</div>
                                </div>
                              )}
                            </form>
                              ...
                              >
                                ...
                                >
                                  <div className="categorybox">
                                    <select className="dropdownselect" data-testid='timedropdownselect'>
                                      <option
                                ...
                                <div className="addressbox">
                                  <div className = 'dateandtimeboxes' >
                                    <div style={{position:'relative'}}>
                                      ...
                                      />
                                      <label htmlFor="datepicker" className="datepicker-label">Start date</label>
                                    </div>
                                </div>
                                  <div
                                    ref={dropdownRef}
                                  ...
                                  >
                                    ...
                                    >
                                      <div className="searchvenuediv1">
                                        ...
                                        >
                                          <div data-testid="dynamicdropdown" className="dropdownLast">
                                            <select data-testid="selectdynamicdropdown"  className="selecttime">
                                              {options}
                                            </select>
                                          </div>
                                        </div>
                                  ...
                                  <div className = 'dateandtimeboxes' >
                                    ...
                                    data-testid='datepicker-container'>
                                      <DatePicker
                                        ...
                                        placeholderText="Select a date"
                                      />
                                      <label htmlFor="datepicker" className="datepicker-label">End date</label>
                                    </div>
                                </div>
                                  <div
                                    className="dateandtimeboxes"
