                ...
                <ul>
                  <li onClick={handleSwitch}>
                    <svg
                      style={{ width: '2rem' }}
                      viewBox="0 0 24 24">
                      <path d="M13.74 13.136l1.405-1.406 4.967 4.972-4.967 4.971-1.404-1.406 2.568-2.571H5.212v-1.989h11.097l-2.569-2.571zm-3.59-2.259l-1.405 1.406-4.967-4.971L8.745 2.34l1.404 1.406-2.568 2.571h11.097v1.99H7.58l2.568 2.57z">
                        </path>
                    </svg>
                    Switch to attending
                    </li>
                  <li style={{ borderBottom: 'solid 1.3px #e4e0ec' }}>
                  <svg 
                    style={{ width: '2rem' }}
                    id="user-chunky_svg__eds-icon--user-chunky_svg" 
                    x="0"
