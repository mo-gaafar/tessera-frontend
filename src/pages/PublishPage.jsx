        ...
        <div className="previewBox">
          ...
          <div className="publishDetails">
            ...
            <div className="previewLink">
              <a data-spec="eds-link" target="_blank" href="" class="eds-link">
                <span>
                  Preview your event
                  <i
                    ...
                    >
                      ...
                      <div className="startDate">
                        ...
                        <DatePicker
                          ...
                          disabled={publishType === 'now' ? 'disabled' : ''}
              ...
              <div className="changeToPublic">
                ...
                <div className="dateAndZone">
                  <div className="publishDate">
                    <div
                      className={
                        privateType === 'private' ? 'date disabled' : 'date'
                      }
                    >
                      <svg
                        id="calendar-chunky_svg__eds-icon--calendar-chunky_svg"
                      ...
                      <div className="startDate">
                        ...
                        <DatePicker
                          selected={publishDate}
                          disabled={privateType === 'private' ? 'disabled' : ''}
                          onChange={date => setPublishDate(date)}
                        />
                      </div>
                    </div>
