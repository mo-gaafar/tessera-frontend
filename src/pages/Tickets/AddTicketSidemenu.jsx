          ...
          <div className="AddTicketsMenuDiv">
                ...
                <div className='CreateTicketInfoDiv'>
                    <div className='TicketTypeSelectorDiv'>
                        <button className={(ticketType === "paid")?"PaidTierButton selected" : "PaidTierButton"} onClick={()=> setTicketType("paid")}>
                            Paid
                        </button>
                        <button className={(ticketType === "free")?"FreeTierButton selected" : "FreeTierButton"} onClick={()=> setTicketType("free")}>
                            Free
                        </button>
                    ...
                    <div className={`TicketNameDiv ${error ? 'error' : ''}`}>
                        <div className="NameTextboxDiv">
                            ...
                            <label>
                                <input className="TicketNameInputDiv" type="text" value={ticketName} onChange={(e) => {setTicketName(e.target.value)}} />
                            </label>
                            </form>
                        </div>
                        ...
                        <div className='PriceTextboxDiv'>
                            <div className='PriceLabelDiv'>
                                ...
                                <div className='PriceAmountDiv'>
                                    <input className='PriceAmountInput' value={ticketPrice} disabled={(ticketType === "free")?"disabled":""} placeholder="0.00" type="text" onChange={(e) => setTicketPrice(e.target.value)} />
                                </div>
                            </div>

                        </div>
                    </div>
                        {priceError && <div className="AvailabilityError">Price is required.</div>}
                ...
                <div className='ButtonsMenuDiv'>
                    <button className=' CancelButton'onClick={() => {props.setIsMenuOpen(false);clearInputs();}}>Cancel</button>
                    <button className='SaveButton' onClick={handlereplaceContentAfterSaveClick}>Save </button>
                </div>
          </div>
        )}
        </AddTicketsSideMenu>
