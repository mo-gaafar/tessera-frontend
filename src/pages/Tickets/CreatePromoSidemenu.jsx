...
export function CreatePromocode(props) {
  ...
  return (
    ...
    <CsvPromocode>
      <div
        className={props.isCreatePromoMenuOpen ? 'MainCsvPromoOpen' : 'closed'}
      >
        ...
        <div className="ButtonsMenuDiv">
          <button
            ...
            onClick={props.handleCloseCreatePromoMenu}
          >
            Cancel
          </button>

          <button className="SaveButton" onClick={props.setIsPromoIntroOpen}>
            Save{' '}
          </button>
        </div>
      </div>
