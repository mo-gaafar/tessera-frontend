...
export default function CreateTickets() {
    ...
    const [data, setData] = useState([
        { NameColumn1: "A", CodeTypeColumn2: "B", DiscountColumn3: "C", UsesColumn4: "D", StatusColumn5: "E" },
        { NameColumn1: "F", CodeTypeColumn2: "G", DiscountColumn3: "H", UsesColumn4: "I", StatusColumn5: "J" },
        { NameColumn1: "K", CodeTypeColumn2: "L", DiscountColumn3: "M", UsesColumn4: "N", StatusColumn5: "O" },
        { NameColumn1: "P", CodeTypeColumn2: "Q", DiscountColumn3: "R", UsesColumn4: "S", StatusColumn5: "T" },
        { NameColumn1: "U", CodeTypeColumn2: "V", DiscountColumn3: "W", UsesColumn4: "X", StatusColumn5: "Y" }
    ]);
    ...
    <MainTicketsDiv>
        ...
        <TicketCreatedDiv>
            ...
            <div className='TicketsTabsDiv'>
                <button className='TicketsTabsButton' onClick={handleHelloClick}>
                    Admission
                </button>
            ...
            <div className='AdmissionsDiv'>
                <div className='AddTicketsDiv'>
                    <button className='AddTicketsButton' onClick={() => {setIsMenuOpen(true)}}>
                        Add tickets
                    </button>
                ...
                <div className='AllTicketsDiv'> 
                    <div className='TicketCreatedInfoDiv'onClick={() => {setIsMenuOpen(true)}}>
                        <svg className="TicketCreatedScrollSvg"  xml:space="preserve"><path fill="#45494E" d="M6 10V8h12v2H6zm0 6v-2h12v2H6z"></path></svg>
                ...
                <div className='EventCapacityDiv'>
                    <div className='EventCapacityLabelDiv'>
                        Event capacity <svg className='EventCapacitySvg'  xml:space="preserve"><path id="info-chunky_svg__eds-icon--info-chunky_base" fill-rule="evenodd" clip-rule="evenodd" d="M12 6c3.3 0 6 2.7 6 6s-2.7 6-6 6-6-2.7-6-6 2.7-6 6-6zm0 14c4.4 0 8-3.6 8-8s-3.6-8-8-8-8 3.6-8 8 3.6 8 8 8z"></path><path id="info-chunky_svg__eds-icon--info-chunky_dot" fill-rule="evenodd" clip-rule="evenodd" d="M11 8h2v2h-2z"></path><path id="info-chunky_svg__eds-icon--info-chunky_line" fill-rule="evenodd" clip-rule="evenodd" d="M11 11h2v5h-2z"></path></svg>
                    </div>
                    <div className='TotalSoldTickets'>
                        0/50
                    </div>
                </div>
            ...
            <div className='PromocodesDiv'>
                ...
                <PromocodesPageDiv>
                    <div className='PromocodesInfoAndButtons'>
                        <h2 className='PromocodesTitleLabel'>Attract more attendees with promo codes</h2>
                        ...
                        <div className='PromocodesButtonsDiv'>
                            <button className='CreatePromocodeButton' onClick={() => setIsCreatePromoMenuOpen(!isMenuOpen)}>
                            Create promo code
                            </button>
                    ...
                    <div className='PromocodesImgDiv'>
                        <img className='PromocodesImg' src="https://cdn.evbstatic.com/s3-build/fe/build/images/379badca6639dc1c5a14473fe52ab756-PromotionsCallToActionIllustrationSvg.svg" />
                    </div>
                </PromocodesPageDiv>}
                ...
                <PromocodesSavePageDiv>
                    ...
                    <div className='TableDiv'>
                        <table>
                            <thead>
                                <tr>
                                <th style={{ width: getColumnWidth("NameColumn1") }}>Name</th>
                                <th style={{ width: getColumnWidth("CodeTypeColumn2") }}>Code type</th>
                                <th style={{ width: getColumnWidth("DiscountColumn3") }}>Discount</th>
                                <th style={{ width: getColumnWidth("UsesColumn4") }}>Uses</th>
                                <th style={{ width: getColumnWidth("StatusColumn5") }}>Status</th>
                                </tr>
                            </thead>
                            <tbody>
                                {data.map((row, index) => (
                                <tr key={index}>
                                    <td className="NameColumn1">{row.NameColumn1}</td>
                                    <td className="CodeTypeColumn2">{row.CodeTypeColumn2}</td>
                                    <td className="DiscountColumn3">{row.DiscountColumn3}</td>
                                    <td className="UsesColumn4">{row.UsesColumn4}</td>
                                    <td className="StatusColumn5">{row.StatusColumn5}</td>
                                </tr>
                                ))}
                            </tbody>
                        </table>
        ...
        <CreatePromocode setIsPromoIntroOpen={() => setIsPromoIntroOpen(false)} isCreatePromoMenuOpen={isCreatePromoMenuOpen} handleCloseCreatePromoMenu={() => setIsCreatePromoMenuOpen(false)}/>
        ...
        <AddTicketSidemenu event={event} isMenuOpen={isMenuOpen} setIsMenuOpen={setIsMenuOpen} setreplaceContentAfterSave={setreplaceContentAfterSave}/>
    </MainTicketsDiv>
    </>
  );
}