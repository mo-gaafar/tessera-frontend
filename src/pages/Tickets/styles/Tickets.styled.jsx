...
export const AddTicketsSideMenu = styled.div`
    ...
    .NameTextboxDiv:hover, .AvailableQuantityTextboxDiv:hover, .TicketPriceDiv:hover, .DateBoxDiv:hover{
...
export const CreatePromoSideMenu = styled.div`
  ...
  .LimitedAmountDiv,.LimitedAmountTextboxDiv,.LimitedAmountLabelDiv,.AmountInput,.AvailabilityError{
