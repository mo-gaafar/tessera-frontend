...
export default function Organize(props) {
  ...
  let showOpt = nameEvents
    ? Array(nameEvents.filteredEvents.length).fill(false)
    : '';
  ...
  const handleClickingOutside = event => {
    if (
      referenceEdit.current &&
      !referenceEdit.current.contains(event.target)
    ) {
      // if clicked outside of the ref div, hide the element
          ...
          >
            <div className="event-data">
              ...
              <div className="data-name">
                ...
                <div className="date">
                  {convertUtcToLocalTime(list.basicInfo.startDateTime, false)}
                </div>
              </div>
            </div>
            ...
            <div className="event-price-status">
              <div className="event-sold">
                <div className="rate-div">
                  {nameEvents.eventsoldtickets[index]}/
                  {nameEvents.maxCapacity[index]}
                </div>
                <div className="App">
  ...
  function handleSearch() {
    ...
    const filtered = nameEvents.filteredEvents.filter(obj => {
      return obj.basicInfo.eventName
        .toLowerCase()
  ...
  const exportCsv = () => {
    fetch(
      'https://www.tessera.social/api/event-management/csv-exports?filterBy=allevents',
      {
        method: 'GET',
        headers: {
